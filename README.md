...
| unstable   | Latest unstable release (from `develop` branch)                                                 | azure-pipelines-dockercli:24.0.2 | 1:2.39.2-1~bpo11+1   | 3.3.0   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-git/unstable?style=flat-square) |
