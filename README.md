...
| unstable   | Latest unstable release (from `develop` branch)                                                 | azure-pipelines-dockercli:24.0.7 | 2.43.0               | 3.4.1   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-git/unstable?style=flat-square) |
